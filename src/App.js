...
function App() {
  ...
  return (
    <div className="App">
      <Navigation/>
      <Switch>
        <Route path="/order-pizza" render={() => <PizzaForm addOrder={addOrder} orders={orders} cancelOrder={cancelOrder} orderToEdit={orderToEdit} editOrder={editOrder} saveOrder={saveOrder}/>} />
